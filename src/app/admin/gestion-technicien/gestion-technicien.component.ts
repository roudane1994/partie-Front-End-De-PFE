...
@Component({
  selector: 'app-gestion-technicien',
  templateUrl: './gestion-technicien.component.html',
  styleUrls: ['./gestion-technicien.component.css']
})
export class GestionTechnicienComponent implements OnInit {
 ...
 public tab;
  ...
  if(this.searchText=="agentActive")  this.etat=true;
    ...
    this.getTechnicien(this.etat,this.pageActuel);
  ...
  getTechnicien(etat:boolean,numPage:number){
    this.authService.getTechnicien(etat,numPage).subscribe(
      (data)=>{
